...
/**
 * SellerRegistration to allow a Seller to create his personnal space
 * @author User
 */
public class SellerRegistration extends javax.swing.JFrame {
    ...
    /**
     * Constructor with an agence parameter to get all the data from other classes
     * @param agence
     */
    public SellerRegistration(Agence agence) {
        initComponents();
        this.agence = agence;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seller's Registration");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            password = Integer.parseInt(String.valueOf(jTextField4.getText()));
            name = jTextField1.getText();
            surname = jTextField2.getText();
            
            boolean bool;
            bool = agence.registrateNewSeller(name, surname, ID, password);
            
            Seller checkSeller = new Seller(name, surname, ID, password);
            if(bool == true){
                
                SellerInterface sellerInterface = new SellerInterface(agence, checkSeller);
